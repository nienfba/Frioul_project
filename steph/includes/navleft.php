  ...
  <div class="row">
      ...
      <form>
        <div class="form-row align-items-center w-80">
          ...
          <div class="input-group mb-2">
            ...
            <input type="text" class="form-control rounded-left" id="inlineFormInputGroup" placeholder="hashtag">
              </div>
          </div>
      </form>
    </div>
    <div class="col-md-4 mt-2">
      <div class="row float-right">
        <button type="button" class="btn btn-primary mr-2" style="border-radius:100px">
