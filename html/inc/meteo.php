  ...
  // AJOUTER UNE BALISE li
     ...
     var codeHtmlLi = '<div class = "border">'
                        ...
                        '<div class = "meteo-flex padding-botom" >'
                          ...
                          + '<div class="meteo-index">' + screenHour[6] + ':' + '00' + '</div>'
                          + '<div class="meteo-index">' + screenHour[8] + ':' + '00' + '</div>'
                        + '</div>' +
                      '</div>' +
                      '<div class = "border">'
                        ...
                        + '<div class = "meteo-flex">'
                          + '<div class="meteo-index">' + '<img src="https://openweathermap.org/img/w/'+ iconScreenDay[0][0] + '.png">' + '</div>'
                        ...
                        + '</div>' +
                        '<div class = "meteo-flex" >'
                          + '<div class="meteo-index">' + tempMaxScreen[0] + '°' + ' / ' + tempMinScreen[0] + '°' +  '</div>'
                          + '<div class="meteo-index">' + tempMaxScreen[1] + '°' + ' / ' + tempMinScreen[1] + '°' +  '</div>'
                          + '<div class="meteo-index">' + tempMaxScreen[2] + '°' + ' / ' + tempMinScreen[2] + '°' + '</div>'
                          + '<div class="meteo-index">' + tempMaxScreen[3] + '°' + ' / ' + tempMinScreen[3] + '°' + '</div>'
                          + '<div class="meteo-index">' + tempMaxScreen[4] + '°' + ' / ' + tempMinScreen[4] + '°' + '</div>'
                        + '</div>' +
                        '<div class = "meteo-flex" >'
                          + '<div class="meteo-index">' + ' vent '+ ' ' + windMaxScreen[0] + ' ' + 'km/h' +  '</div>'
                          + '<div class="meteo-index">' + ' vent '+ ' ' + windMaxScreen[1] + ' ' + 'km/h' +  '</div>'
                          + '<div class="meteo-index">' + ' vent '+ ' ' + windMaxScreen[2] + ' ' + 'km/h' +  '</div>'
                          + '<div class="meteo-index">' + ' vent '+ ' ' + windMaxScreen[3] + ' ' + 'km/h' +  '</div>'
                          + '<div class="meteo-index">' + ' vent '+ ' ' + windMaxScreen[4] + ' ' + 'km/h' +  '</div>'
                        + '</div>' +
                      '</div>';
