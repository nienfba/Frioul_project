				...
				<div class="row colonneg">
					...
					<!-- Debut Colonne de gauche -->
						<div class="col-lg-6 ">
							...
							<div class="imgport">
								<img  class="img-fluid" src="img/port.jpg" alt="">
							</div>
							<p class="col-lg-12">
							...
							<!-- Réseaux sociaux -->
							<section class="icons col-lg-12">
								<h3>Partagez avec vos amis</h3>
								<span class="social col-lg-3"><img src="media/icons/envelope.png" alt=""></span>
								<span class="social col-lg-3"><img src="media/icons/facebook.png" alt=""></span>
								<span class="social col-lg-3"><img src="media/icons/twitter.png" alt=""></span>
								<span class="social col-lg-3"><img src="media/icons/pinterest.png" alt=""></span>
							</section>
						</div>
